									...
									return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('EINE FRAGE BEANTWORTEN LASSEN')
													]))
											]));
								} else {
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('row g-0')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$Attributes$class('input-group input-group-lg w-75 mx-auto my-3 align-middle')
																]),
															_List_fromArray(
																[
																	A2(
